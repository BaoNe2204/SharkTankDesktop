    ...
    public class SalesModule : IModule
    {
        ...
        public List<NavBarItem> GetMenuItems()
        {
            ...
            menuItems.Add(new NavBarItem
            {
                ...
                Childs = new List<NavBarItem>
                {
                    new NavBarItem { ID = _menuId++, Text = "Báo giá", ParentID = quoteId },
                    new NavBarItem { ID = _menuId++, Text = "Hóa đơn", ParentID = quoteId },
                    new NavBarItem { ID = _menuId++, Text = "Theo dõi doanh thu", ParentID = quoteId }
                }
            });
