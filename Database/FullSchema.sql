/* Full database schema and seed data for SharkTank ERP */
/* Generated by Antigravity */

/* =============================================================
   SharkTank ERP - FULL SCHEMA (SQL Server)
   Run from top to bottom on the SharkTankERP database
   ============================================================= */
...
CREATE TABLE dbo.KhachHang (
    ...
    HanMucNo  DECIMAL(18,2) NOT NULL CONSTRAINT DF_KhachHang_HanMucNo DEFAULT(0),
    GhiChu    NVARCHAR(MAX) NULL,
...
CREATE TABLE dbo.HoaDon (
    ...
    DaThanhToan DECIMAL(18,0) NOT NULL CONSTRAINT DF_HoaDon_DaThanhToan DEFAULT(0),
    GhiChu    NVARCHAR(MAX)  NULL,
...
IF OBJECT_ID('dbo.QLCoHoiBanHang','U') IS NOT NULL DROP TABLE dbo.QLCoHoiBanHang;
...
CREATE TABLE dbo.Leads (
    ...
    NgayTao     DATETIME       NOT NULL CONSTRAINT DF_Leads_NgayTao DEFAULT(GETDATE())
);
GO
...
CREATE TABLE dbo.QLCoHoiBanHang (
    QLCoHoiBanHangID INT            IDENTITY(1,1) NOT NULL CONSTRAINT PK_QLCoHoiBanHang PRIMARY KEY,
    TenCoHoi         NVARCHAR(200)  NOT NULL,
    LeadID           INT            NULL,
    GiaTriDuKien     DECIMAL(18,2)  NULL,
    XacSuat          INT            NULL,
    TrangThai        NVARCHAR(50)   NULL,
    NgayTao          DATETIME       NOT NULL CONSTRAINT DF_QLCoHoi_NgayTao DEFAULT(GETDATE()),
    CONSTRAINT FK_QLCoHoi_Leads FOREIGN KEY (LeadID) REFERENCES dbo.Leads(LeadID)
);
GO

-- ============================================================
-- MISSING TABLES FOR ACCOUNTING, INVENTORY, HR, SYSTEM
-- ============================================================

-- TÀI CHÍNH / KẾ TOÁN
IF OBJECT_ID('dbo.DoanhThu','U') IS NOT NULL DROP TABLE dbo.DoanhThu;
...
-- BÁN HÀNG
IF OBJECT_ID('dbo.DonHangSales','U') IS NOT NULL DROP TABLE dbo.DonHangSales;
CREATE TABLE dbo.DonHangSales (
...
IF OBJECT_ID('dbo.PhieuThuNo','U') IS NOT NULL DROP TABLE dbo.PhieuThuNo;
CREATE TABLE dbo.PhieuThuNo (
    Id INT IDENTITY(1,1) PRIMARY KEY,
    MaKH NVARCHAR(20) NOT NULL CONSTRAINT FK_PhieuThuNo_KhachHang FOREIGN KEY REFERENCES dbo.KhachHang(MaKH),
...
IF OBJECT_ID('dbo.ViTriKho','U') IS NOT NULL DROP TABLE dbo.ViTriKho;
CREATE TABLE dbo.ViTriKho (
    MaViTri NVARCHAR(50) PRIMARY KEY,
    TenViTri NVARCHAR(200) NOT NULL,
    MaKho NVARCHAR(50) NULL CONSTRAINT FK_ViTriKho_Kho FOREIGN KEY REFERENCES dbo.Kho(MaKho)
);
GO

IF OBJECT_ID('dbo.BienBanKiemKe','U') IS NOT NULL DROP TABLE dbo.BienBanKiemKe;
CREATE TABLE dbo.BienBanKiemKe (
    Id INT IDENTITY(1,1) PRIMARY KEY,
    MaSP NVARCHAR(20) NOT NULL CONSTRAINT FK_BienBanKiemKe_SanPham FOREIGN KEY REFERENCES dbo.SanPham(MaSP),
    TonHeThong INT NOT NULL DEFAULT 0,
    TonThucTe INT NOT NULL DEFAULT 0,
    ChenhLech INT NOT NULL DEFAULT 0,
    NgayKiemKe DATETIME NOT NULL DEFAULT GETDATE()
);
GO

IF OBJECT_ID('dbo.DieuChinhTon','U') IS NOT NULL DROP TABLE dbo.DieuChinhTon;
CREATE TABLE dbo.DieuChinhTon (
    Id INT IDENTITY(1,1) PRIMARY KEY,
    MaSP NVARCHAR(20) NOT NULL CONSTRAINT FK_DieuChinhTon_SanPham FOREIGN KEY REFERENCES dbo.SanPham(MaSP),
    SoLuongDieuChinh INT NOT NULL DEFAULT 0,
...
-- HR
IF OBJECT_ID('dbo.LichSuThayDoiHoSo','U') IS NOT NULL DROP TABLE dbo.LichSuThayDoiHoSo;
CREATE TABLE dbo.LichSuThayDoiHoSo (
    Id INT IDENTITY(1,1) PRIMARY KEY,
    NhanVienId NVARCHAR(20) NOT NULL CONSTRAINT FK_LichSu_NhanVien FOREIGN KEY REFERENCES dbo.NhanVien(NhanVienId),
    TruongThayDoi NVARCHAR(200) NULL,
...
IF OBJECT_ID('dbo.NghiPhep','U') IS NOT NULL DROP TABLE dbo.NghiPhep;
CREATE TABLE dbo.NghiPhep (
    Id INT IDENTITY(1,1) PRIMARY KEY,
    NhanVienId NVARCHAR(20) NOT NULL CONSTRAINT FK_NghiPhep_NhanVien FOREIGN KEY REFERENCES dbo.NhanVien(NhanVienId),
    LoaiPhep NVARCHAR(100) NULL,
    TuNgay DATE NULL,
    DenNgay DATE NULL,
    LyDo NVARCHAR(MAX) NULL,
    SoNgay DECIMAL(18,2) NOT NULL DEFAULT 0,
    TrangThai NVARCHAR(50) NULL DEFAULT N'Chờ duyệt',
    NgayTao DATETIME NOT NULL DEFAULT GETDATE()
);
GO

IF OBJECT_ID('dbo.LamThemGio','U') IS NOT NULL DROP TABLE dbo.LamThemGio;
CREATE TABLE dbo.LamThemGio (
    Id INT IDENTITY(1,1) PRIMARY KEY,
    NhanVienId NVARCHAR(20) NOT NULL CONSTRAINT FK_LamThemGio_NhanVien FOREIGN KEY REFERENCES dbo.NhanVien(NhanVienId),
    Ngay DATE NOT NULL,
    GioBatDau TIME NULL,
    GioKetThuc TIME NULL,
    SoGioOT DECIMAL(18,2) NOT NULL DEFAULT 0,
    LyDo NVARCHAR(500) NULL,
    TrangThai NVARCHAR(50) NULL DEFAULT N'Chờ duyệt'
);
GO
...
-- HỆ THỐNG
IF OBJECT_ID('dbo.CauHinhPhanLoai','U') IS NOT NULL DROP TABLE dbo.CauHinhPhanLoai;
CREATE TABLE dbo.CauHinhPhanLoai (
    Id INT IDENTITY(1,1) PRIMARY KEY,
    TenLoai NVARCHAR(100) NOT NULL,
    Icon NVARCHAR(50) NULL,
    ChiTieuToiThieu DECIMAL(18,2) NOT NULL DEFAULT 0
);
GO

INSERT INTO dbo.CauHinhPhanLoai (TenLoai, Icon, ChiTieuToiThieu) VALUES
(N'Khách Mới', N'⚪', 0),
(N'Tiềm Năng', N'🟢', 10000000),
(N'Thân Thiết', N'⭐', 50000000),
(N'VIP', N'💎', 100000000);
GO
...
DECLARE @sAdminHalf NVARCHAR(64) = LOWER(CONVERT(VARCHAR(32),CONVERT(BINARY(16),NEWID()),2));
...
(N'admin_half', LOWER(CONVERT(VARCHAR(64),HASHBYTES('SHA2_256',CONVERT(VARBINARY(MAX),N'admin123' + @sAdminHalf)),2)), @sAdminHalf, N'Half Admin', N'admin_half@example.com', N'', @rAdmin,1,0,0,@now,@now);
GO
